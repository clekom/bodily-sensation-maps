...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n\tvalue: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _helper = __webpack_require__(/*! ./helper */ \"./src/helper.js\");\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar activityInput = function () {\n\tfunction activityInput(selectror) {\n\t\t_classCallCheck(this, activityInput);\n\n\t\tthis.name = selectror;\n\t\tthis.isShowed = false;\n\t\tthis.create(selectror);\n\t\tthis.initUI();\n\t\tthis.bindEvents();\n\t}\n\n\t_createClass(activityInput, [{\n\t\tkey: 'getActivityValue',\n\t\tvalue: function getActivityValue() {\n\t\t\treturn parseInt(this.slider.value, 10);\n\t\t}\n\t}, {\n\t\tkey: 'getSlider',\n\t\tvalue: function getSlider() {\n\t\t\treturn this.slider;\n\t\t}\n\t}, {\n\t\tkey: 'initUI',\n\t\tvalue: function initUI() {\n\t\t\tthis.resultRow.innerText = 'Aktivität: 0 %';\n\t\t}\n\t}, {\n\t\tkey: 'bindEvents',\n\t\tvalue: function bindEvents() {\n\t\t\tvar _this = this;\n\n\t\t\tthis.slider.addEventListener('input', function () {\n\t\t\t\t_this.resultRow.innerText = 'Aktivität: ' + _this.slider.value + ' %';\n\t\t\t});\n\t\t}\n\t}, {\n\t\tkey: 'setTitle',\n\t\tvalue: function setTitle(selector) {\n\t\t\tthis.titleRow.innerText = selector;\n\t\t}\n\t}, {\n\t\tkey: 'setDescription',\n\t\tvalue: function setDescription(description) {\n\t\t\tthis.descriptionRow.innerText = description;\n\t\t}\n\t}, {\n\t\tkey: 'setTopEndOfSlider',\n\t\tvalue: function setTopEndOfSlider(text) {\n\t\t\tthis.fullActivity.innerText = text;\n\t\t}\n\t}, {\n\t\tkey: 'setBottomEndOfSlider',\n\t\tvalue: function setBottomEndOfSlider(text) {\n\t\t\tthis.noActivity.innerText = text;\n\t\t}\n\t}, {\n\t\tkey: 'show',\n\t\tvalue: function show() {\n\t\t\tthis.container.style.display = 'block';\n\t\t\tthis.isShowed = true;\n\t\t\tthis.showCloseHandler();\n\t\t}\n\n\t\t//todo bessere Lösung finden!\n\n\t}, {\n\t\tkey: 'showCloseHandler',\n\t\tvalue: function showCloseHandler() {\n\t\t\tvar _this2 = this;\n\n\t\t\tif (this.isShowed === true) {\n\t\t\t\tthis.container.addEventListener('mouseleave', function () {\n\t\t\t\t\t_this2.container.style.display = 'none';\n\t\t\t\t\t_this2.container.removeEventListener('mouseleave', function () {\n\t\t\t\t\t\t_this2.isShowed = false;\n\t\t\t\t\t});\n\t\t\t\t});\n\n\t\t\t\tthis.container.addEventListener('touchend', function () {\n\t\t\t\t\t_this2.container.style.display = 'none';\n\t\t\t\t\t_this2.container.removeEventListener('touchend', function () {\n\t\t\t\t\t\t_this2.isShowed = false;\n\t\t\t\t\t});\n\t\t\t\t});\n\t\t\t}\n\t\t}\n\t}, {\n\t\tkey: 'createSlider',\n\t\tvalue: function createSlider(cx, id) {\n\t\t\tvar slider = (0, _helper.createElement)('input', cx);\n\t\t\tslider.type = 'range';\n\t\t\tslider.min = '0';\n\t\t\tslider.max = '100';\n\t\t\tslider.value = '0';\n\t\t\tslider.orient = 'vertical';\n\t\t\tslider.id = 'input_' + id;\n\t\t\treturn slider;\n\t\t}\n\t}, {\n\t\tkey: 'create',\n\t\tvalue: function create(id) {\n\t\t\tthis.container = (0, _helper.createElement)('div', 'input-container');\n\t\t\tthis.titleRow = (0, _helper.createElement)('div', 'activity-row, input-title-row');\n\t\t\tthis.descriptionRow = (0, _helper.createElement)('div', 'activity-row');\n\t\t\tthis.inputContainer = (0, _helper.createElement)('div', 'center');\n\t\t\tthis.inputRow = (0, _helper.createElement)('div', 'center, input-row');\n\t\t\tthis.resultRow = (0, _helper.createElement)('div', 'activity-row, center');\n\t\t\tthis.columnTop = (0, _helper.createElement)('div', 'center');\n\t\t\tthis.columnBottom = (0, _helper.createElement)('div', 'center');\n\t\t\tthis.slider = this.createSlider('slider', id);\n\t\t\tthis.noActivity = (0, _helper.createElement)('div', 'fullActivity');\n\t\t\tthis.fullActivity = (0, _helper.createElement)('div', 'noActivity');\n\n\t\t\tthis.container.appendChild(this.titleRow);\n\t\t\tthis.container.appendChild(this.resultRow);\n\t\t\tthis.container.appendChild(this.descriptionRow);\n\t\t\tthis.container.appendChild(this.columnTop);\n\t\t\tthis.container.appendChild(this.inputContainer);\n\t\t\tthis.inputContainer.appendChild(this.inputRow);\n\t\t\tthis.inputRow.appendChild(this.slider);\n\t\t\tthis.container.appendChild(this.columnBottom);\n\t\t\tthis.columnTop.appendChild(this.noActivity);\n\t\t\tthis.columnBottom.appendChild(this.fullActivity);\n\n\t\t\tthis.setTitle(id);\n\t\t}\n\t}, {\n\t\tkey: 'destroy',\n\t\tvalue: function destroy() {\n\t\t\tthis.columnTop = null;\n\t\t\tthis.columnBottom = null;\n\t\t\tthis.slider = null;\n\t\t}\n\t}]);\n\n\treturn activityInput;\n}();\n\nexports.default = activityInput;\n\n//# sourceURL=webpack:///./src/activityInput.js?");
...
"use strict";
eval("\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _Modal = __webpack_require__(/*! ./Modal */ \"./src/Modal.js\");\n\nvar _Modal2 = _interopRequireDefault(_Modal);\n\nvar _helper = __webpack_require__(/*! ./helper */ \"./src/helper.js\");\n\nvar _activityInput = __webpack_require__(/*! ./activityInput */ \"./src/activityInput.js\");\n\nvar _activityInput2 = _interopRequireDefault(_activityInput);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step(\"next\", value); }, function (err) { step(\"throw\", err); }); } } return step(\"next\"); }); }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar BSM = function () {\n\tfunction BSM() {\n\t\t_classCallCheck(this, BSM);\n\n\t\tthis.data = {\n\t\t\tbodyPartData: [],\n\t\t\tallBodyPartInputs: [],\n\t\t\tuuid: this.create_UUID(),\n\t\t\taction: true,\n\t\t\ttextData: {},\n\t\t\tsliderColors: {\n\t\t\t\tcolor1: [214, 213, 213],\n\t\t\t\tcolor2: [217, 31, 67]\n\t\t\t}\n\t\t};\n\t\tthis.init();\n\t}\n\n\t_createClass(BSM, [{\n\t\tkey: 'create_UUID',\n\t\tvalue: function create_UUID() {\n\t\t\tvar dt = new Date().getTime();\n\t\t\tvar uuid = 'xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx'.replace(/[xy]/g, function (c) {\n\t\t\t\tvar r = (dt + Math.random() * 16) % 16 | 0;\n\t\t\t\tdt = Math.floor(dt / 16);\n\t\t\t\treturn (c == 'x' ? r : r & 0x3 | 0x8).toString(16);\n\t\t\t});\n\t\t\treturn uuid;\n\t\t}\n\n\t\t// can be used if variables like uuid are sent from another source.\n\n\t}, {\n\t\tkey: 'getUrlParamerter',\n\t\tvalue: function getUrlParamerter(sParam) {\n\t\t\tvar sPageURL = decodeURIComponent(window.location.search.substring(1)),\n\t\t\t    sURLVariables = sPageURL.split('&'),\n\t\t\t    sParameterName = void 0,\n\t\t\t    i = void 0;\n\n\t\t\tfor (i = 0; i < sURLVariables.length; i++) {\n\t\t\t\tsParameterName = sURLVariables[i].split('=');\n\n\t\t\t\tif (sParameterName[0] === sParam) {\n\t\t\t\t\treturn sParameterName[1] === undefined ? true : sParameterName[1];\n\t\t\t\t}\n\t\t\t}\n\t\t}\n\t}, {\n\t\tkey: 'init',\n\t\tvalue: function () {\n\t\t\tvar _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {\n\t\t\t\treturn regeneratorRuntime.wrap(function _callee$(_context) {\n\t\t\t\t\twhile (1) {\n\t\t\t\t\t\tswitch (_context.prev = _context.next) {\n\t\t\t\t\t\t\tcase 0:\n\t\t\t\t\t\t\t\t_context.next = 2;\n\t\t\t\t\t\t\t\treturn this.loadTextInputs();\n\n\t\t\t\t\t\t\tcase 2:\n\t\t\t\t\t\t\t\tthis.initElements();\n\t\t\t\t\t\t\t\tthis.bindEvents();\n\t\t\t\t\t\t\t\tthis.createTaskModal();\n\n\t\t\t\t\t\t\tcase 5:\n\t\t\t\t\t\t\tcase 'end':\n\t\t\t\t\t\t\t\treturn _context.stop();\n\t\t\t\t\t\t}\n\t\t\t\t\t}\n\t\t\t\t}, _callee, this);\n\t\t\t}));\n\n\t\t\tfunction init() {\n\t\t\t\treturn _ref.apply(this, arguments);\n\t\t\t}\n\n\t\t\treturn init;\n\t\t}()\n\t}, {\n\t\tkey: 'loadTextInputs',\n\t\tvalue: function loadTextInputs() {\n\t\t\tvar _this = this;\n\n\t\t\tvar path = 'text/texts.json';\n\t\t\treturn fetch(path).then(function (response) {\n\t\t\t\treturn response.json();\n\t\t\t}).then(function (textData) {\n\t\t\t\t_this.data.textData = textData;\n\t\t\t}).catch(function (error) {\n\t\t\t\tconsole.error(error);\n\t\t\t});\n\t\t}\n\t}, {\n\t\tkey: 'initElements',\n\t\tvalue: function initElements() {\n\t\t\tvar bodyParts = document.querySelectorAll('.st0');\n\t\t\tvar inputArea = document.querySelector('#activity-inputs');\n\n\t\t\tvar _iteratorNormalCompletion = true;\n\t\t\tvar _didIteratorError = false;\n\t\t\tvar _iteratorError = undefined;\n\n\t\t\ttry {\n\t\t\t\tfor (var _iterator = bodyParts[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {\n\t\t\t\t\tvar part = _step.value;\n\n\t\t\t\t\tvar bodyPartData = {\n\t\t\t\t\t\tname: part.id,\n\t\t\t\t\t\tcounter: 0\n\t\t\t\t\t};\n\t\t\t\t\tthis.data.bodyPartData.push(bodyPartData);\n\n\t\t\t\t\t//Create Input Elements\n\t\t\t\t\tvar bodyPartActivityInput = new _activityInput2.default(part.id);\n\n\t\t\t\t\tbodyPartActivityInput.setDescription(this.data.textData['activiy-description']);\n\t\t\t\t\tbodyPartActivityInput.setTopEndOfSlider(this.data.textData['slider-bottom']);\n\t\t\t\t\tbodyPartActivityInput.setBottomEndOfSlider(this.data.textData['slider-top']);\n\n\t\t\t\t\tthis.data.allBodyPartInputs.push(bodyPartActivityInput);\n\t\t\t\t\tinputArea.appendChild(bodyPartActivityInput.container);\n\t\t\t\t}\n\t\t\t} catch (err) {\n\t\t\t\t_didIteratorError = true;\n\t\t\t\t_iteratorError = err;\n\t\t\t} finally {\n\t\t\t\ttry {\n\t\t\t\t\tif (!_iteratorNormalCompletion && _iterator.return) {\n\t\t\t\t\t\t_iterator.return();\n\t\t\t\t\t}\n\t\t\t\t} finally {\n\t\t\t\t\tif (_didIteratorError) {\n\t\t\t\t\t\tthrow _iteratorError;\n\t\t\t\t\t}\n\t\t\t\t}\n\t\t\t}\n\t\t}\n\t}, {\n\t\tkey: 'bindEvents',\n\t\tvalue: function bindEvents() {\n\t\t\tthis.bodyPartEvents();\n\t\t\tthis.inputEvents();\n\t\t\tthis.submit();\n\t\t}\n\t}, {\n\t\tkey: 'showInputHandler',\n\t\tvalue: function showInputHandler(event) {\n\t\t\tvar selectedBodypartInput = this.data.allBodyPartInputs.find(function (bPart) {\n\t\t\t\treturn bPart.name === event.target.id;\n\t\t\t});\n\t\t\tselectedBodypartInput.show();\n\t\t}\n\t}, {\n\t\tkey: 'bodyPartEvents',\n\t\tvalue: function bodyPartEvents() {\n\t\t\tvar _this2 = this;\n\n\t\t\tvar allBodyParts = this.data.bodyPartData;\n\t\t\tvar _iteratorNormalCompletion2 = true;\n\t\t\tvar _didIteratorError2 = false;\n\t\t\tvar _iteratorError2 = undefined;\n\n\t\t\ttry {\n\t\t\t\tfor (var _iterator2 = allBodyParts[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {\n\t\t\t\t\tvar part = _step2.value;\n\n\t\t\t\t\tvar selector = part.name;\n\t\t\t\t\tdocument.querySelector('#' + selector).addEventListener('click', function (event) {\n\t\t\t\t\t\t_this2.showInputHandler(event);\n\t\t\t\t\t});\n\t\t\t\t}\n\t\t\t} catch (err) {\n\t\t\t\t_didIteratorError2 = true;\n\t\t\t\t_iteratorError2 = err;\n\t\t\t} finally {\n\t\t\t\ttry {\n\t\t\t\t\tif (!_iteratorNormalCompletion2 && _iterator2.return) {\n\t\t\t\t\t\t_iterator2.return();\n\t\t\t\t\t}\n\t\t\t\t} finally {\n\t\t\t\t\tif (_didIteratorError2) {\n\t\t\t\t\t\tthrow _iteratorError2;\n\t\t\t\t\t}\n\t\t\t\t}\n\t\t\t}\n\t\t}\n\t}, {\n\t\tkey: 'setBodyPartColor',\n\t\tvalue: function setBodyPartColor(rgb, input) {\n\t\t\tvar selector = input.split('_').pop();\n\t\t\tvar bodyPartToFill = document.getElementById(selector);\n\t\t\tbodyPartToFill.style.fill = 'rgb(' + rgb[0] + ',' + rgb[1] + ',' + rgb[2] + ')';\n\t\t}\n\t}, {\n\t\tkey: 'inputEvents',\n\t\tvalue: function inputEvents() {\n\t\t\tvar _this3 = this;\n\n\t\t\tvar _loop = function _loop(inputElement) {\n\t\t\t\tinputElement.slider.addEventListener('input', function (event) {\n\t\t\t\t\tvar rgb = _this3.calculateColor(_this3.data.sliderColors.color1, _this3.data.sliderColors.color2, event.target.value);\n\t\t\t\t\t_this3.setBodyPartColor(rgb, event.target.id);\n\t\t\t\t\t_this3.updateActivation(inputElement.name, event.target.value);\n\t\t\t\t});\n\t\t\t};\n\n\t\t\tvar _iteratorNormalCompletion3 = true;\n\t\t\tvar _didIteratorError3 = false;\n\t\t\tvar _iteratorError3 = undefined;\n\n\t\t\ttry {\n\t\t\t\tfor (var _iterator3 = this.data.allBodyPartInputs[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {\n\t\t\t\t\tvar inputElement = _step3.value;\n\n\t\t\t\t\t_loop(inputElement);\n\t\t\t\t}\n\t\t\t} catch (err) {\n\t\t\t\t_didIteratorError3 = true;\n\t\t\t\t_iteratorError3 = err;\n\t\t\t} finally {\n\t\t\t\ttry {\n\t\t\t\t\tif (!_iteratorNormalCompletion3 && _iterator3.return) {\n\t\t\t\t\t\t_iterator3.return();\n\t\t\t\t\t}\n\t\t\t\t} finally {\n\t\t\t\t\tif (_didIteratorError3) {\n\t\t\t\t\t\tthrow _iteratorError3;\n\t\t\t\t\t}\n\t\t\t\t}\n\t\t\t}\n\t\t}\n\t}, {\n\t\tkey: 'calculateColor',\n\t\tvalue: function calculateColor(color1, color2, value) {\n\t\t\tvar rgb = [Math.round(color1[0] - (color1[0] - color2[0]) * value / 100), Math.round(color1[1] - (color1[1] - color2[1]) * value / 100), Math.round(color1[2] - (color1[2] - color2[2]) * value / 100)];\n\t\t\treturn rgb;\n\t\t}\n\t}, {\n\t\tkey: 'submit',\n\t\tvalue: function submit() {\n\t\t\tvar _this4 = this;\n\n\t\t\tvar submitbutton = document.querySelector('#submitbutton');\n\t\t\tsubmitbutton.addEventListener('click', function () {\n\t\t\t\t_this4.createSafetyModal();\n\t\t\t});\n\t\t}\n\t}, {\n\t\tkey: 'updateActivation',\n\t\tvalue: function updateActivation(selector, value) {\n\t\t\tvar bPartSelector = this.data.bodyPartData.find(function (b) {\n\t\t\t\treturn b.name === selector;\n\t\t\t});\n\t\t\tbPartSelector.counter = parseInt(value);\n\t\t}\n\t}, {\n\t\tkey: 'createTaskModal',\n\t\tvalue: function createTaskModal() {\n\t\t\tvar _this5 = this;\n\n\t\t\tdocument.getElementById('info').addEventListener('click', function () {\n\t\t\t\tvar taskModal = new _Modal2.default();\n\t\t\t\ttaskModal.setTitle(_this5.data.textData.instruction_title);\n\t\t\t\ttaskModal.setDescription(_this5.data.textData.instruction_text);\n\t\t\t\ttaskModal.show();\n\t\t\t});\n\t\t}\n\t}, {\n\t\tkey: 'createSafetyModal',\n\t\tvalue: function createSafetyModal() {\n\t\t\tvar _this6 = this;\n\n\t\t\tvar question = new _Modal2.default();\n\t\t\tquestion.setTitle(this.data.textData.send_notice_title);\n\t\t\tquestion.setDescription(this.data.textData.send_notice_text);\n\t\t\tvar finalSubmitButton = (0, _helper.createElement)('button', 'modalButtonStyle');\n\t\t\tfinalSubmitButton.innerText = \"Weiter\";\n\t\t\tfinalSubmitButton.addEventListener('click', function () {\n\t\t\t\t_this6.sendAllData();\n\t\t\t});\n\t\t\tquestion.setFooterContent(finalSubmitButton);\n\t\t\tquestion.show();\n\t\t}\n\t}, {\n\t\tkey: 'sendAllData',\n\t\tvalue: function sendAllData() {\n\t\t\tvar data = {\n\t\t\t\tid: this.data.id,\n\t\t\t\tbodyPartData: this.data.bodyPartData\n\t\t\t};\n\t\t\tconsole.log(data);\n\t\t\tvar path = 'php/data.php';\n\n\t\t\tfetch(path, {\n\t\t\t\tmethod: \"POST\",\n\t\t\t\tmode: \"same-origin\",\n\t\t\t\tcredentials: \"same-origin\",\n\t\t\t\theaders: {\n\t\t\t\t\t\"Content-Type\": \"application/json\"\n\t\t\t\t},\n\t\t\t\tbody: JSON.stringify({\n\t\t\t\t\tdata: data\n\t\t\t\t})\n\t\t\t}).then(function (res) {\n\t\t\t\tconsole.log(\"Sucess:\", JSON.stringify(res.json()));\n\t\t\t}).then(function () {\n\t\t\t\tdocument.location.href = 'success.html';\n\t\t\t}).catch(function (error) {\n\t\t\t\tconsole.error('Error:', error);\n\t\t\t});\n\t\t}\n\t}]);\n\n\treturn BSM;\n}();\n\nvar runBSM = new BSM();\n\n//# sourceURL=webpack:///./src/index.js?");
